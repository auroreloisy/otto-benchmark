...
from windy.evaluate.parameters.__defaults import *
...
def Worker(episode):
    ...
    2. The agent moves according to the policy
...
def run():
    ...
    if am_i_root():
        ...
        # Print parameters
        print("R_BAR = " + str(mydummyenv.R_bar))
        print("V_BAR = " + str(mydummyenv.V_bar))
        print("TAU_BAR = " + str(mydummyenv.tau_bar))
        print("LAMBDA_BAR = " + str(mydummyenv.lambda_bar))
