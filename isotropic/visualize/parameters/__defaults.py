...
# Policy
POLICY = 0  # -2=AlphaVec, -1=RL, O=infotaxis, 1=space-aware infotaxis, 5=random, 6=greedy, 7=mean distance, 8=voting, 9=mls
MODEL_PATH = None  # saved model for POLICY=-1, e.g., "../learn/models/20220201-230054/20220201-230054_model"
ALPHAVEC_PATH = None  # saved Perseus policy for POLICY=-2, e.g., "../../perseus/vf_aurore_rate_1.0_gamma_0.95_boxlength_18_difflength_1.0_shaping_factor_0.0_shaping_power_1.0_nb_30000_epsilon_0.1_it_7.pkl"
