...
import argparse
import importlib
from isotropic.classes.sourcetracking import SourceTracking as env
from isotropic.classes.visualization import Visualization

# import default globals
from isotropic.visualize.parameters.__defaults import *
...
if POLICY == -1:
    from isotropic.classes.rlpolicy import RLPolicy
    from isotropic.classes.valuemodel import reload_model
    if MODEL_PATH is None:
        raise Exception("MODEL_PATH cannot be None with a neural network policy!")
elif POLICY == -2:
    from isotropic.classes.alphavecpolicy import AlphaVecPolicy
